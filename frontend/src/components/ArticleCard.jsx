...
export default function ArticleCard({ article }) {
  ...
  return (
    ...
    >
      {article.cover_url ? (
        <div className="h-44 overflow-hidden border-b border-slate-200/70 bg-slate-100 dark:border-white/10">
          <img
        ...
        <div className="flex h-44 items-center justify-center border-b border-slate-200/70 bg-slate-100 dark:border-white/10 dark:bg-slate-800/50">
          <FileTextIcon className="h-12 w-12 text-slate-300 dark:text-slate-600" />
        </div>
      )}
